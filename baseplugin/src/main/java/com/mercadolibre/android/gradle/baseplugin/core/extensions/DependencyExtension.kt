 ...
 */
internal fun Dependency.setAllowListDefault() = copy(
    group = group ?: "",
    name = name ?: UNDEFINED_VERSION_PATTERN,
    version = version ?: UNDEFINED_VERSION_PATTERN,
    expires = expires ?: ""
)

internal fun VersionCatalogDependency.setProjectDefault() = Dependency(group, name, version, "", false)
